		...
		<tr>
			<td align="center" valign="top" style="padding:5px;">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td height="20" align="right" valign="middle" class="word_orange">当前位置：个人借阅 &gt; 丢书处理 &gt;&gt;&gt;</td>
					</tr>
					<tr>
						<td valign="top"><table width="100%" border="0"
								cellspacing="0" cellpadding="0">
								<tr>
									<td height="57" background="Images/lose.gif">&nbsp;</td>
								</tr>
								<tr>
									<td align="center" valign="top">
										...
										<table width="95%" border="1" cellpadding="0" cellspacing="0"
											...
											<tr>
												...
												<td align="center" style="padding:5px;"><a
													href="${pageContext.request.contextPath}/ok">图书丢失</a></td>
											</tr>
											<%
												}
											%>
