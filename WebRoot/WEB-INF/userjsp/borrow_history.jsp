...
<%
	List<Borrow> brlist = new BorrowDao().sHByN(username);
%>
		...
		<tr>
			<td align="center" valign="top" style="padding:5px;">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td height="20" align="right" valign="middle" class="word_orange">当前位置：个人借阅 &gt; 借阅历史 &gt;&gt;&gt;</td>
					</tr>
					<tr>
						<td valign="top"><table width="100%" border="0"
								cellspacing="0" cellpadding="0">
								<tr>
									<td height="57" background="Images/borroe_history.gif">&nbsp;</td>
								</tr>
								<tr>
										...
										<table width="95%" border="1" cellpadding="0" cellspacing="0"
											...
											<%
												for (int i = 0; i < brlist.size(); i++) {
													...
													ID = borrows.getId();
													borrowime = borrows.getBorrowtime();
