...
%>
<%
	List<Users> ulists = new UsersDao().sadmin();
%>
<html>
			...
			<td valign="top" bgcolor="#FFFFFF"><table width="100%"
					...
					<tr>
						<td height="27" valign="top" style="padding:5px;"
							class="word_orange">当前位置：用户管理 &gt; 管理员库 &gt;&gt;&gt;</td>
					</tr>
					<tr>
							...
							<form action="" method="post" name="form1">
								...
								<table width="98%" border="1" cellpadding="0" cellspacing="0"
									...
									<tr align="center" bgcolor="#e3F4F7">
										<td width="25%" bgcolor="#F9D16B">姓名</td>
										...
										<td width="10%" bgcolor="#F9D16B">用户类型</td>
										<td width="10%" bgcolor="#F9D16B">用户权限</td>
